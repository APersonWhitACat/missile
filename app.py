...
with st.sidebar:
    ...
    if use_ramjet:
        ...
        ramjet_max_burn_time = st.number_input("Ramjet maximum burn time s", value=35.0, min_value=0.0, step=1.0)
        ...
        st.caption("Ramjet thrust uses the dev air-density formula, Mach efficiency around the selected best Mach, and reduced thrust during hard turns.")
    else:
